(function(global) {
    var Timetables = function(option) {
        ...
        this.leftHandWidth = styles.leftHandWidth || 80;
        this.Gheight = styles.Gheight || 48;
        this.defaultPalette = ["#f05261", "#48a8e4", "#ffd061", "#52db9a", "#70d3e6", "#52db9a", "#3f51b5", "#f3d147",
            "#4adbc3", "#673ab7", "#f3db49", "#76bfcd", "#b495e1", "#ff9800", "#8bc34a"
        ];
        this.palette = (typeof styles.palette === "boolean" && !styles.palett) ? false : (styles.palette || []).concat(this
            .defaultPalette);
        this._init()
    };
    Timetables.prototype = {
        _init: function(option) {
            ...
            var Gheight = (style.Gheight || this.Gheight) + 10;
            var palette;
            ...
            timetable.forEach(function(values, index) {
                ...
                values.forEach(function(item, i) {
                    ...
                    courseItem.onclick = function(e) {
                        ...
                        gridOnClick && gridOnClick(info, this);
                    };
